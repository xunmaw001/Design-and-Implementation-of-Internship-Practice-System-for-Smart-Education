...
public class ShijianrenshuOrderView extends ShijianrenshuOrderEntity implements Serializable {
	...
	* 状态类型的值
	*/
	@ColumnInfo(comment="状态类型的字典表值",type="varchar(200)")
	private String shijianrenshuOrderValue;
	/**
	* 审核状态的值
	*/
	@ColumnInfo(comment="审核状态的字典表值",type="varchar(200)")
	private String shijianrenshuOrderYesnoValue;
	...
	public ShijianrenshuOrderView() {

	}

	public ShijianrenshuOrderView(ShijianrenshuOrderEntity shijianrenshuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, shijianrenshuOrderEntity);
	...
	* 获取： 状态类型的值
	*/
	public String getShijianrenshuOrderValue() {
		return shijianrenshuOrderValue;
	}
	/**
	* 设置： 状态类型的值
	*/
	public void setShijianrenshuOrderValue(String shijianrenshuOrderValue) {
		this.shijianrenshuOrderValue = shijianrenshuOrderValue;
	}
	//当前表的
	/**
	* 获取： 审核状态的值
	*/
	public String getShijianrenshuOrderYesnoValue() {
		return shijianrenshuOrderYesnoValue;
	}
	/**
	* 设置： 审核状态的值
	*/
	public void setShijianrenshuOrderYesnoValue(String shijianrenshuOrderYesnoValue) {
		this.shijianrenshuOrderYesnoValue = shijianrenshuOrderYesnoValue;
	}
	...
	public String toString() {
		return "ShijianrenshuOrderView{" +
			", shijianrenshuOrderValue=" + shijianrenshuOrderValue +
			", shijianrenshuOrderYesnoValue=" + shijianrenshuOrderYesnoValue +
