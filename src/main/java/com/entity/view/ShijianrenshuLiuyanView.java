...
public class ShijianrenshuLiuyanView extends ShijianrenshuLiuyanEntity implements Serializable {
	...
	public ShijianrenshuLiuyanView() {

	}

	public ShijianrenshuLiuyanView(ShijianrenshuLiuyanEntity shijianrenshuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, shijianrenshuLiuyanEntity);
	...
	public String toString() {
		return "ShijianrenshuLiuyanView{" +
