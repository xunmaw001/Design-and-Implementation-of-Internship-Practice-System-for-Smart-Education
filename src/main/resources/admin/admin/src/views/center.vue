  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业联系人' prop="qiyeLianxiren">
               <el-input v-model="ruleForm.qiyeLianxiren"  placeholder='企业联系人' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业位置' prop="qiyeAddress">
               <el-input v-model="ruleForm.qiyeAddress"  placeholder='企业位置' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='qiye'"  label='行业' prop="hangyeTypes">
                 <el-select v-model="ruleForm.hangyeTypes"  placeholder='请选择行业'>
                     <el-option
...
// 注册表 企业 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.qiyeLianxiren)&& 'qiye'==this.flag){
                             this.$message.error('企业联系人不能为空');
                             return
                         }
                         ...
                         if((!this.ruleForm.hangyeTypes)&& 'qiye'==this.flag){
