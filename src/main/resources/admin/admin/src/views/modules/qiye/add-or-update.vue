               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="企业联系人" prop="qiyeLianxiren">
                       <el-input v-model="ruleForm.qiyeLianxiren"
                                 placeholder="企业联系人" clearable  :readonly="ro.qiyeLianxiren"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="企业位置" prop="qiyeAddress">
                       <el-input v-model="ruleForm.qiyeAddress"
                                 placeholder="企业位置" clearable  :readonly="ro.qiyeAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   qiyeAddress: [
                              { required: true, message: '企业位置不能为空', trigger: 'blur' },
                          ],
                   qiyeEmail: [
