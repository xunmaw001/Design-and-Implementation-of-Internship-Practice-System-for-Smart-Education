...
var centerMenu = [
    ...
    ,{
        name: '任务收藏',
        url: '../shijianrenshuCollection/list.html'
    }
    ,{
        name: '任务订单',
        url: '../shijianrenshuOrder/list2.html'
    }
...
var indexNav = [
    ...
    {
        name: '任务',
        url: './pages/shijianrenshu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/shixishijianxitong/admin/dist/index.html#/login";
